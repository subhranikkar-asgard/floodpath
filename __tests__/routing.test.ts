...
describe('parseOSRMRoute', () => {
    ...
    legs: [
      {
        steps: [
          {
            maneuver: { location: [88.36, 22.57] as [number, number], type: 'depart', modifier: undefined },
            name: 'Park Street',
            distance: 800,
          },
          {
            maneuver: { location: [88.36, 22.57] as [number, number], type: 'turn', modifier: 'left' },
            name: 'Chowringhee Road',
            distance: 4000,
          },
          {
            maneuver: { location: [88.36, 22.57] as [number, number], type: 'arrive', modifier: undefined },
            name: '',
            distance: 0,
          },
        ],
  ...
  it('falls back to "Local roads" when no named steps exist', () => {
    const unnamedRoute = {
      ...mockRoute,
      legs: [{ steps: [{ maneuver: { location: [88.36, 22.57] as [number, number], type: 'depart' }, name: '', distance: 100 }] }],
    };
    ...
    routes: [
      {
        ...
        duration: 900,
        distance: 5000,
        legs: [{ steps: [{ maneuver: { location: [88.36, 22.57] as [number, number], type: 'depart' }, name: 'MG Road', distance: 5000 }] }],
      },
      {
        geometry: '_p~iF~ps|U_ulLnnqC',
        duration: 1200,
        distance: 6500,
        legs: [{ steps: [{ maneuver: { location: [88.36, 22.57] as [number, number], type: 'depart' }, name: 'AJC Bose Road', distance: 6500 }] }],
      },
    ],
  };
